...
Partial Class MedGuiR
    ...
    Private Sub InitializeComponent()
        ...
        Me.WS.Items.AddRange(New Object() {"Cdromance", "CoolROM", "DOMS", "EagleForces", "Edge Emulation", "EMUPARADISE", "Free-ISO", "GamulatoR", "Planet Emu", "RETRO!", "Rom Find", "Rom Hustler", "ROMULATION", "RomsMode", "Viim's Lair", "WoWroMs", "Hacks", "Translations", "Mednafen Bios", "MedGui BoxArt Pack", "MedGui Snaps Pack"})
        ...
        Me.Label6.Text = "MedGuiR v.0.126"
        '
        'Label7
        '
