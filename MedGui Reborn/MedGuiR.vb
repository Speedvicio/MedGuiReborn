...
Public Class MedGuiR
    ...
    Private Sub LoadRomToolStripButton_Click(sender As Object, e As EventArgs) Handles LoadRomToolStripButton.Click
        ...
        fdlg.Filter = "All supported format (*.zip,*.7z,*.rar,*.cue,*.toc,*.m3u,*.ccd,*.cfs,*.ciso,*.iso,*.ecm,*.pbp,*.chd)|*.zip;*.7z;*.rar;*.cue;*.toc;*.m3u;*.ccd;*.cfs;*.ciso;*.iso;*.ecm;*.pbp;*.chd|File CUE (*.cue)|*.cue|File TOC (*.toc)|*.toc|File M3U (*.m3u)|*.m3u|File CCD (*.ccd)|*.ccd|File MAI (*.mai)|*.rar|File ZIP (*.zip)|*.zip|File 7z (*.7z)|*.7z|File rar (*.rar)|*.rar|Compressed CD (*.ecm,*.pbp,*.cfs,*.ciso,*.chd)|*.ecm;*.pbp;*.cfs;*.ciso;*.chd|PS-X EXE (*.exe)|*.exe|All files (*.*)|*.*"
        fdlg.FilterIndex = 1
